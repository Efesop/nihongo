...
export const ROOM_ENCOUNTERS = {
  ...
  // Room 6: Burning forest — single-screen (triggers at screen x-positions)
  6: [
    { triggerX: 120, speaker: "player", textJp: "道場が...先生が...", text: "The dojo... Sensei...", duration: 2000 },
    { triggerX: 450, speaker: "player", textJp: "煙の匂い...火が広がってる。", text: "Smoke... the fire is spreading.", duration: 1800 },
    { triggerX: 750, speaker: "player", textJp: "腕が...熱い。印が光ってる。", text: "My arm... it's hot. The mark is glowing.", duration: 2200 },
  ],
...
export function getSceneConfig(roomIndex) {
  ...
  if (roomIndex === 10) return {
    ...
    label: '出会い', labelEn: 'THE ENCOUNTER', particleType: 'embers', groundLevel: 0.78,
  ...
  if (roomIndex === 11) return {
    bgKey: 'bg_forest_story', gradientColors: ['#1a0a1a', '#140818', '#0a0410'],
    label: '闇路', labelEn: 'THE DARK PATH', particleType: 'embers', groundLevel: 0.78,
    characters: { left: 'player', right: 'shadow' },
    entrance: { left: 'walk_in', right: 'already_there' },
  };
  ...
  if (roomIndex >= 19 && roomIndex <= 21) return {
    ...
    label: 'ネオン東京', labelEn: 'NEON TOKYO', particleType: 'embers', groundLevel: 0.78,
  ...
  if (roomIndex >= 22 && roomIndex <= 25) return {
    ...
    label: '暗路', labelEn: 'DARK STREETS', particleType: 'embers', groundLevel: 0.78,
    characters: { left: 'player', right: roomIndex === 22 ? 'shadow' : 'hacker' },
  ...
  if (roomIndex >= 26 && roomIndex <= 31) return {
    ...
    label: '地下', labelEn: 'THE UNDERGROUND', particleType: 'embers', groundLevel: 0.78,
