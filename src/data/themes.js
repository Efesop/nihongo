...
export const THEMES = {
  dark: {
    ...
    tx:"#f0eee9", m:"#85858c", m2:"#a5a5ad",
    a:"#c0282a", g:"#4f8ec4", go:"#9b8ecf", bl:"#5a8ec4",
    ro:"#e8a8aa", // romaji — soft coral, higher contrast than accent red on dark bg
  ...
  light: {
    ...
    tx:"#111114", m:"#888580", m2:"#5a5854",
    a:"#a81e20", g:"#3a6ea0", go:"#7c6fcd", bl:"#3a6ea0",
    ro:"#7a1416", // romaji — darker red on light bg for legibility
