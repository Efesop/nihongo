...
"ミ":["3️⃣","Three lines — middle","Three horizontal strokes","Three horizontal lines stacked up — look for the line in the middle and you've found mi."],
"ム":["🫎","Moose antlers","Angular antler shape","A pair of moose antlers viewed from the front — the angular strokes branch upward like a bull moose's impressive rack."],
          ...
          : <div>
              ...
              <div style={{display:"flex",alignItems:"center",gap:16,marginBottom:14}}>
                <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"}}>
                  <div style={{fontSize:90,lineHeight:1,marginBottom:8}}>{ch}</div>
                  <div style={{fontSize:28,fontWeight:700,color:c.a,fontFamily:mono,marginBottom:10}}>{rom}</div>
                  {speakBtn(ch)}
                </div>
                <img src={mnemonicImg} alt={m?m[1]:rom}
                  ...
                  style={{width:"45%",maxWidth:220,borderRadius:12,flexShrink:0}}/>
              </div>
              {/* Story card */}
